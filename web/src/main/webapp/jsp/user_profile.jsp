...
<%@page import="java.text.SimpleDateFormat"%><div style="margin: 0pt auto; width: 655px; padding-top: 15px;">
	...
	<div id="divItemMusic" class="divItemMusic">
		<form action="<%=cfg.getProperty("site.url")%>/a/auth/profile" method="post">
					...
					<div style="margin-left: 30pt;">
						<table>
							<tr>
								...
								<td>
									<input type = "text" name="<%=cfg.getProperty("user.username")%>" value="<%=user.getUserName() %>" readonly="readonly" class="input-text"/>
								</td>
							</tr>
							<tr>
								<td class = "register-left-column">
							...
							<tr>
								...
								<td>
									<input type = "text" name="re_<%=cfg.getProperty("user.email")%>" value="" class="input-text"/>
								</td> -->
							</tr>
							<tr>
								<td colspan="2">
					...
					<div style="margin-left: 30pt;">
						<table>
							...
							<tr>
								...
								<td>
									<input type = "text" name="<%=cfg.getProperty("user.birthday")%>" value="<%=new SimpleDateFormat("dd/MM/yyyy").format(user.getBirthday()) %>" class="input-text"/>
								</td>
							</tr>
							<tr>
								<td class = "register-left-column">
